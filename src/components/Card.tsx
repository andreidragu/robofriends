...
const Card: React.FC<CardProps> = ({ username, name, email }) => {
    return (
        <Box d="inline-grid" bg="green.200" maxW="300px" height="360px" overflow="hidden" rounded="md" p={4} m={4} boxShadow="md" _hover={{ transform: "scale(1.05)" }} transition="all .2s ease-in-out">
